package com.mshop.orderservice.service.order.impl;
...
import com.mshop.orderservice.external.GHNService;
import com.mshop.orderservice.internal.AccountService;
import com.mshop.orderservice.internal.CartService;
import com.mshop.orderservice.internal.ProductService;
import com.mshop.orderservice.internal.UserService;
import com.mshop.orderservice.repository.OrderRepository;
import com.mshop.orderservice.repository.OrderSupplierRepository;
import com.mshop.orderservice.repository.entity.Role;
import com.mshop.orderservice.repository.entity.order.*;
...
//                .orderSuppliers(order.getOrderSuppliers().stream().map(this::toOrderSupplierDto).collect(Collectors.toList()))
    ...
    public List<OrderDto> getAllOrderByUserId(String userId) throws ApiException {
        return orderRepository.getOrdersByUserId(userId).stream().filter(order ->
