...
class CommentController(
    ...
    @PutMapping("discovery/products/internal/purchase")
    suspend fun putUserProductWhenPurchase(
        @RequestHeader(Constants.HEADER_USER_ID) userId: String,
        @RequestBody product: PatchAmountProductDto) {
        userProductService.putUserProductWhenPurchase(userId,product)
    }
    ...
    suspend fun getReviews(
        ...
        val offsetRequest = com.mshop.base.OffsetRequest(offset, limit)
        userProductService.getReviewsByUserIdAndReviewed(userId, isReViewed, offsetRequest)
    }
}